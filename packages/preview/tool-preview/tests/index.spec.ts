...
describe('mediaTypeOf', () => {
  it('maps common produced-file extensions to MIME types', () => {
    expect(PreviewContract.mediaTypeOf('/w/a.png')).toBe('image/png')
    expect(PreviewContract.mediaTypeOf('/w/a.jpeg')).toBe('image/jpeg')
    expect(PreviewContract.mediaTypeOf('/w/a.jpg')).toBe('image/jpeg')
    expect(PreviewContract.mediaTypeOf('/w/a.webp')).toBe('image/webp')
    expect(PreviewContract.mediaTypeOf('/w/a.gif')).toBe('image/gif')
    expect(PreviewContract.mediaTypeOf('/w/a.svg')).toBe('image/svg+xml')
    expect(PreviewContract.mediaTypeOf('/w/s.html')).toBe('text/html')
    expect(PreviewContract.mediaTypeOf('/w/s.htm')).toBe('text/html')
    expect(PreviewContract.mediaTypeOf('/w/data.json')).toBe('application/json')
    expect(PreviewContract.mediaTypeOf('/w/slides.pptx')).toBe('application/vnd.openxmlformats-officedocument.presentationml.presentation')
    expect(PreviewContract.mediaTypeOf('/w/README.txt')).toBe('text/plain')
    expect(PreviewContract.mediaTypeOf('/w/README.md')).toBe('text/plain')
    expect(PreviewContract.mediaTypeOf('/w/blob.bin')).toBe('application/octet-stream')
  })
})
