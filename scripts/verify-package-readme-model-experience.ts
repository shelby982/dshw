...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/preview/preview': { kind: 'none', reason: 'Durable preview contract (meta payload + pure readers); a produced-file tool and the browser renderer own any model-facing effect.' },
