...
需要：`agentDefaultModel` · `agents` · `attachments` · `fileAttachments` · `llm` · `sessions` · `sessionProjections` · `sessionQuery` · `typert` · `workspaceRegistry`
...
来源：[`packages/attachment/attachment-local/src/index.ts:58`](../packages/attachment/attachment-local/src/index.ts)
...
来源：[`packages/preview/tool-preview/src/index.ts:27`](../packages/preview/tool-preview/src/index.ts)
...
- `@deepseek-ai/dsh-preview`（[`packages/preview/preview/src/index.ts`](../packages/preview/preview/src/index.ts)）
